...
function ITag(params){
    ...
    let Body = `<style id="ITStile-${IDInsatance}">.ITag_btn:hover {fill: #888888 !important;}@keyframes ITagAnimationINUP {0% {top: -320px;}100% {top: 20px;}}@keyframes ITagAnimationINRIGTH {0% {right: -320px;}100% {right: 20px;}}@keyframes ITagAnimationOUTUP {100% {top: -320px;}0% {top: 20px;}}@keyframes ITagAnimationOUTRIGTH {100% {right: -320px;}0% {right: 20px;}}@keyframes ITagAnimationINDOWN {0% {bottom: -320px;}100% {bottom: 20px;}}@keyframes ITagAnimationOUTDOWN {100% {bottom: -320px;}0% {bottom: 20px;}}@keyframes ITagAnimationProgressBar {0% {width: 100%;}100% {width: 0%;}}</style>`
    ...
    ProgBar.addEventListener("animationend", (event) => {
        Tag.style.animation = `1s ${animationOutName} linear forwards`;
    })
    
    
}
function ITag_Close(IDInsatance, animationOutName) {
    document.getElementById(`ITag-${IDInsatance}`).style.animation = `1s ${animationOutName} linear forwards`;
