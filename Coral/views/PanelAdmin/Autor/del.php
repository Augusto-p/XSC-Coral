            ...
            <div id="Formulario">
                ...
                <div class="data">
                    <div class="row">
                        ...
                        <div class="col2 col">
                            <input type="text" name="nombre" id="Nombre" placeholder="Nombre" class="inputs noselect"
                                disabled>
                    ...
                    <div class="row triple-row">
                        <div class="col bioCol">
                            <textarea name="Biografia" id="Biografia" maxlength="500" placeholder="Biografia"
                                disabled></textarea>
                        </div>
