            ...
            <div class="list-item noselect">
                ...
                <div class="list-item-data">
                    ...
                    <div class="list-item-data-down">
                        ...
                        <img src="<?php echo constant('URL'); ?><?=$Autor->foto;?>"
                            onclick="goTo('<?php echo constant('URL');?>book?Autor=<?=$Autor->id?>')">
                        <h6 onclick="goTo('<?php echo constant('URL');?>book?Autor=<?=$Autor->id?>')">
                            <?=$Autor->nombre;?></h6>
                        <?php }; ?>
                ...
                <div class="list-item-sale">
                    <div class="list-item-sale-ultra-up" onclick="options(event)">
                        ...
                        <div class="list-item-sale-ultra-up-pointer"></div>
                        <div class="item-menu">
                            <button onclick="goTo('<?php echo constant('URL');?>book/view?id=<?=$Book->isbn?>')">Ver
                                Libro</button>
                            <!-- <button>Ver Categoria</button> -->
                            <button
                                onclick="goTo('<?php echo constant('URL');?>book?Editorial=<?=$Book->IDEditorial?>')">Ver
                                Editorial</button>
                            <hr>
