        ...
        <div class="Select-Zone">
          <div class="Select-Div">
            ...
            <div class="Select-Div-in">
              ...
              <label for="Radio-MetododePago">Metodo de Pago</label>
            </div>
            <div class="Select-Div-in">
            ...
            <div class="Select-Div-in">
              <input type="radio" name="Modo" id="Radio-Buscar" onchange="ChangeMod(5)">
              <label for="Radio-Buscar">Buscar</label>
            </div>
          ...
          <div class="select-Values">
            ...
            <div class="Select_NotView">
                  ...
                  <Button class="btnSeach" onclick="getbyFecha()" type="button"><img src="<?php echo constant('URL'); ?>public/Recursos/icons/lupa.svg"></Button>
            </div>
            <!-- Seach -->
            <div class="Select_NotView">
                  <input type="number" name="ID" id="Select_ID" class="inputs" placeholder="ID">
            </div>
          </div>
        </div>
