                ...
                <div class="Select-Zone">
                    ...
                    <div class="select-Values">
                        ...
                        <div class="Select_NotView">
                            <div>
                                <select name="Editorial" id="Select_Editorial" class="inputs"
                                    onchange="getbyEditorial()">
                        ...
                        <!-- MP -->
                        <div class="Select_NotView">
                            <input type="text" name="MP" id="Select_MP" class="inputs" placeholder="Metodo de Pago"
                                onkeyup="getbyMP(event)">
                        </div>
                        <!-- Fecha -->
                        <div class="Select_NotView">
