            ...
            <div id="Formulario">
                ...
                <div class="data">
                    <div class="row">
                        ...
                        <div class="col2 col">
                            <input type="text" name="Titulo" id="Titulo" placeholder="Titulo" class="inputs" disabled>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col1 col">
                            <input type="number" name="Precio" id="Precio" placeholder="Precio" class="inputs" disabled>

                        </div>
                        <div class="col2 col">
                            <div class="row-in-col">
                                <select name="Editorial" id="Editorial" class="inputs" disabled>
                        ...
                        <div class="col1 col">
                            <div class="row-in-col">
                                <input type="text" name="Categoriain" id="Categoriain" placeholder="Categorias"
                                    class="inputs" disabled>
                            </div>
                        </div>
                        <div class="col2 col">
                            <div class="row-in-col">
                                <select name="Autor" id="Autor" class="inputs" disabled>
...
<script src="<?php echo constant('URL'); ?>public/js/AdminPanel/Book/del.js"></script>
