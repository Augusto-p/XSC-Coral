            ...
            <div id="Formulario">
                ...
                <div class="data">
                    ...
                    <div class="row">
                        ...
                        <div class="col2 col">
                            <input type="text" name="Numero" id="Numero" placeholder="Numero de Telefono" class="inputs" disabled>

                        </div>
                    </div>
                    <div class="row">
                        <div class="col1 col">
                            <input type="text" name="Direccion" id="Direccion" placeholder="Dirección" class="inputs" disabled>
