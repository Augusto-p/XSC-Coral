...
<body>
    ...
    <section class="content">
        ...
        <div class="conten-data">
            <div id="Formulario">
                <h2 id="titulo">Eliminar Editorial</h2>

                <div class="data">
                    <div class="row">
                        <div class="col1 col">
                            <div class="row-in-col">
                                <input type="number" onkeyup="IDonKeyUp(event)" name="ID" id="ID" placeholder="ID"
                                    class="inputs">
                                <Button class="btnSeach" onclick="Seach()"><img
                    ...
                    <div class="row">
                        <div class="col1 col">
                            <input type="email" name="email" id="Email" placeholder="Email" class="inputs" disabled>

                        </div>
                        <div class="col2 col">
                            <input type="text" name="Numero" id="Numero" placeholder="Número de Teléfono" class="inputs"
                                disabled>
                    ...
                    <div class="row">
                        ...
                        <div class="col2 col">
                            <input type="text" name="Web" id="Web" placeholder="Web" class="inputs" disabled>
...
<script src="<?php echo constant('URL'); ?>public/js/AdminPanel/Editorial/del.js"></script>
