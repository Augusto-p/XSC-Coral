...
<div class="banner">
        ...
        <div class="menu">
            <ul class="menu-ul">
                ...
                <li class="logos-res"><button><img src="<?php echo constant('URL'); ?>public/Recursos/icons/home.svg"></button></li>
                <li class="lista-res"><b><a href="<?php echo constant('URL'); ?>book">Explorar</a></b></li>
                <li class="logos-res"><button><img src="<?php echo constant('URL'); ?>public/Recursos/icons/safari.svg"></button></li>
