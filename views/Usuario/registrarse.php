    ...
    <section id="g-der">
      <form action="<?php echo constant('URL'); ?>Usuario/signupClientes" method="post" id="form-reg"
        ...
        <div id="form-sls">
          ...
          <div id="form-end">
            <input type="number" name="Numero" id="Numero" placeholder="Numero" class="inputs" step="1" min="1"
            ...
            <input type="number" name="Codigo" id="CPostal" placeholder="Codigo Postal" class="inputs" step="1" min="1"
              onkeypress="return event.charCode >= 48 && event.charCode <= 57">
            <input type="text" name="Departamento" list="depaList" id="departamento" placeholder="Departamento"
              class="inputs">
